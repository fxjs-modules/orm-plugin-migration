...
function generate(name: string, extension: string, templateName: string | Class_Buffer) {
...
Migrator.prototype.up = addPromiseInterface(
  function(migrationName, cb) {
    var self = this;
...
Migrator.prototype.down =  addPromiseInterface(
  function(migrationName, cb) {
    var self = this;
    this.setup(function(err) {
      if(err) return cb(err);
...
Migrator.prototype.generate = addPromiseInterface(
  function(title, cb){
    var self = this;
    this.mkdir(function(){
